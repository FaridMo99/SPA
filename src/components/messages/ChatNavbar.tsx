...
function ChatNavbar() {
  ...
  console.log(chats);
  return (
    <nav className="min-h-[85vh] w-1/8 border-r-2 p-2 border-r-green-300 dark:border-r-dark-green bg-gray-50 dark:bg-dark-gray z-10 flex flex-col items-center">
      <button
